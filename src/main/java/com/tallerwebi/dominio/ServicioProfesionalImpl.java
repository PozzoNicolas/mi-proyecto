...
public class ServicioProfesionalImpl implements ServicioProfesional {
    ...
    public ServicioProfesionalImpl() {
        Profesional p1 = new Profesional("Mario D. Pastore V1", 111);
        Profesional p2 = new Profesional("Victor S. Rolon V1", 222);
        Profesional p3 = new Profesional("Mariana Enriquez V2", 333);
